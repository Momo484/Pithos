...
public:
   ...
   * * This function parses standard UCI strings (e.g., "e2e4", "e7e8q"),
   * validates if the move is pseudo-legal and respects check conditions, and
   ...
   * @return false If the move was illegal, improperly formatted, or the game is
   * already over.
   */
...
private:
  ...
  /**
   * @brief Updates the current game state, by getting information from the
   * board class.
   */
  void updateResult();
};
